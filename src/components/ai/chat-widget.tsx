...
const initialMessages: ChatMessage[] = [
    {
        role: "ADMIN",
        content: "Hi, I'm the CineTube assistant. Ask me about movies, TV shows, recommendations, or help finding content you love.",
    },
]
                ...
                <Card className="mb-4 flex h-[32rem] w-[min(24rem,calc(100vw-2rem))] flex-col overflow-hidden border-border/70 bg-card/92 shadow-[0_32px_100px_-48px_rgba(15,23,42,0.82)] backdrop-blur-xl">
                    <CardHeader className="flex flex-row items-start justify-between gap-3 border-b border-border/60">
                        <div className="space-y-2">
                            ...
                            <div>
                                <CardTitle className="text-xl">CineTube Chat</CardTitle>
                                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                                    Ask about movies, get recommendations, or find your next favorite show.
                                </p>
                            </div>
                        </div>
                        <Button
                    ...
                    <CardContent className="flex min-h-0 flex-1 flex-col gap-4 p-4">
                        ...
                        >
                            <Input
                                ...
                                placeholder="Ask about movies or get recommendations"
                            ...
                            <div className="flex items-center justify-between gap-3">
                                ...
                                >
                                    {error || "Responses are generated by Groq for fast entertainment guidance."}
                                </p>
                                <Button
                                    type="submit"
                                    size="sm"
